...
const populatePage = () => {
    if (getProdId() === 0) { showProduct(products[0]) }
    else if (getProdId() === 1) { showProduct(products[1]) }
    else if (getProdId() === 2) { showProduct(products[2]) }
    else if (getProdId() === 3) { showProduct(products[3]) }
    else if (getProdId() === 4) { showProduct(products[4]) }
...
const showProduct = (prod) => {
    ...
    prod.productInfoHTML.forEach((para) => {
