...
{  id: 3,
    ...
    "I'm here to answer all of your burning questions so bring that list!",
    "For the past 5 years I have honed the flower growing skills specifically for our climate right here in San Diego. I have produced enough cut flowers to sell to Flower Shops and Florists all over the county as well as making my own designs.",
    "Whether you have lots of experience or just a few pots to grow in, you can grow cut flowers and you should! The joy it will bring you is so worth it, not to mention how much our planet needs more green spaces right now.",
    "After purchase we will set up a time for a 30 minute zoom call or audio call, whatever is your preference. For in person consultations, you must be within San Diego County and I will spend an hour, to an hour and a half at your home with follow up emails and resources.",
    "Scheduling will take place via email after purchase.",
   "Looking forward to helping you grow something beautiful!"],
    thumbnailUrls:[
...
//saves product identifier from shop page to open product page for correct product
...
const getProdId = ()=> {
    ...
    else {return JSON.parse(localStorage.getItem("productId"));
     }
    };

//saves shop items to local storage in shop.js so they can be seen in shopping cart
const saveToCart =(shoppingCart)=> {
...
const getShoppingCart = ()=> {
    ...
    else {return JSON.parse(localStorage.getItem("shoppingCart"));
     }
    };



//sales and use tax rate in Vista Ca as of Mar 2023
const vistaSalesAndUseTax = .0825;
